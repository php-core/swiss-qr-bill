...
Forked from https://github.com/sprain/php-swiss-qr-bill with the intent to fix open issues and improve the library.
...
In a QR IBAN, the *institute id*, which is defined in the 5th to 9th character, is a number in the range of 30000 to 31999. (Example: CH44 **3199 9**123 0008 8901 2). For how to detect it in code, see https://github.com/php-core/php-swiss-qr-bill/issues/182#issuecomment-1229539977
...
See https://github.com/php-core/php-swiss-qr-bill/issues/129 
